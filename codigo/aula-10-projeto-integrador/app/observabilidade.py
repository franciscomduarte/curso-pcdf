"""Observabilidade — herdada sem mudança da Aula 9.

Métricas por serviço (chamadas/falhas/latência/p95) e o traço de uma
investigação. Nesta aula, o traço ganha mais valor: como o roteador
(`roteador.py`) pode mandar uma ocorrência por um caminho mais longo (com
revisão dupla) ou mais curto, o traço é o que revela qual caminho cada
ocorrência realmente percorreu.
"""
...
def formatar_traco(atendido_por: list[dict]) -> str:
    ...
    Nesta aula, o traço tem tamanho VARIÁVEL: uma ocorrência de furto tem 3
    etapas; uma de roubo, roteada para revisão dupla, tem 4."""
    linhas = []
