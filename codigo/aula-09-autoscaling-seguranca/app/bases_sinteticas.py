"""Dados fictícios — as mesmas ocorrências da Aula 7, agora servidas pelo cluster.
...
# Boletim FICTÍCIO com um padrão de injeção embutido — para a demonstração do
# guardrail (Bloco 3). O texto de um BO é entrada não confiável desde a Aula 1;
# aqui, pela primeira vez, o SIGMA barra isso ANTES de o texto entrar no fluxo.
BOLETIM_SUSPEITO = (
